...
const Student = () => {
    ...
    const initialData = [
        { id: 1, StudentName: "John Doe Student", principalName: "john abc", phone: "91+ 923-456-7890", email : 'abc123xyz@GiMailShirt.com', status : 0 },
        { id: 2, StudentName: "Jane Smith Student", principalName: "jane abc", phone: "91+ 998-765-4321", email : 'abc123xyz@GiMailShirt.com', status : 0 },
        { id: 3, StudentName: "Alice Johnson Student", principalName: "alic abcm", phone: "91+ 956-789-0123", email : 'abc123xyz@GiMailShirt.com', status : 1 },
