...
const validationSchema = Yup.object({
  name: Yup.string()
    ...
    AdharNumber: Yup.string()
        .matches(/^[0-9]{12}$/, 'Phone number must be exactly 10 digits')
  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center">
      <div className="bg-white p-8 pt-4 rounded shadow-lg max-w-lg w-full relative">
        ...
        <h2 className="text-2xl font-bold mb-4 pb-2 border-b-2 border-gray-200 -mx-6 text-center text-gray-800">Add New Attender</h2>
        <Formik
          initialValues={{ name: '', AdharNumber: '',  phone: '', email: '', status : 0}}
          ...
          {() => (
            <Form>
                ...
                <div className="mb-4">
                    ...
                    <label className="block text-gray-800 mb-2" htmlFor="AdharNumber">
                        Adhar Number
                    </label>
                    <Field
                    type="text"
